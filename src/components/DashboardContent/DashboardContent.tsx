      ...
      <div className="grid gap-4 md:grid-cols-2 lg:grid-cols-4">
        ...
        <Card>
          <CardHeader className="flex flex-row items-center justify-between space-y-0 pb-2">
            ...
            <MdStar className="h-4 w-4 text-blue-500" />
          </CardHeader>
          <CardContent>
        ...
        <Card>
          <CardHeader className="flex flex-row items-center justify-between space-y-0 pb-2">
            ...
            <MdLocalFlorist className="h-4 w-4 text-blue-500" />
          </CardHeader>
          <CardContent>
          ...
          <CardContent>
            <ResponsiveContainer width="100%" height={300}>
              <BarChart data={data}>
                ...
                <YAxis />
                <Tooltip />
                <Bar dataKey="recipes" fill="#3667d9" />
              </BarChart>
            </ResponsiveContainer>
          </CardContent>
        </Card>
          ...
          <CardContent>
            <div className="space-y-4">
              <div className="flex items-center">
                <FaUtensils className="mr-2 h-4 w-4 text-blue-500" />
